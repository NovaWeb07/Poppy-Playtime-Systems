package com.poppyplaytime.systems.block.entity;
...
public class TvBlockEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TvBlockEntity(BlockPos pos, BlockState state) {
		super(ModBlockEntities.TV_BLOCK.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(TvBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<TvBlockEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<TvBlockEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
