...
package com.poppyplaytime.systems.abilities.quicksand;
...
public class QuicksandRegistry {
    ...
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, "nova");

    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, "nova");
