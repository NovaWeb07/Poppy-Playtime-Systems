package com.poppyplaytime.systems.abilities;
...
@Mod.EventBusSubscriber(modid = "nova", bus = Mod.EventBusSubscriber.Bus.FORGE)
public class PoppyHandQuicksandAbility {
    ...
    public static void onRightClick(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (!BuiltInRegistries.ITEM.getKey(stack.getItem())
                .equals(new ResourceLocation("nova", "player_hand"))) return;
