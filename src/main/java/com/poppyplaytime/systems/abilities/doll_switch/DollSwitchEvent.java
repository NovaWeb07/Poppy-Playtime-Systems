package com.poppyplaytime.systems.abilities.doll_switch;
...
@Mod.EventBusSubscriber(modid = "nova")
public class DollSwitchEvent {
    ...
    public static void onRightClick(PlayerInteractEvent.EntityInteract event) {
        ...
        if (id == null || !id.toString().equals("nova:doll_poppy")) return;
    ...
    public static void onServerTick(TickEvent.ServerTickEvent event) {
        ...
        if (tick == TOTAL_SPIN_TICKS + 20) {
            ...
            Entity prototype = ForgeRegistries.ENTITY_TYPES
                    .getValue(new ResourceLocation("nova:prototype"))
                    .create(activeLevel);
